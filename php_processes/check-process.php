...
$mail = new PHPMailer(true);                              // Passing `true` enables exceptions
    ...
    $mail->Subject = "Access Request for Review";
		$mail->Body = $row4['name'] . " is requesting for " . $row['access_requested']  . " access" . "<br> The Request has already been checked, kindly view and approve access request details through the EEI Service Desk website http://localhost/eei0219-master/details.php?id=" . $row['ticket_id'];
    $mail->send();
